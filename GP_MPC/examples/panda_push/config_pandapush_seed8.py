...
def get_config_seed8(len_horizon=10, num_repeat_actions=5, include_time_model=False,):
	...
	reward_config = RewardConfig(
		...
		target_state_norm=[(-0.05190832+10)/20,(0.14618306+10)/20, (0.02+10)/20, (0+10)/20, (0+10)/20, (0+10)/20],

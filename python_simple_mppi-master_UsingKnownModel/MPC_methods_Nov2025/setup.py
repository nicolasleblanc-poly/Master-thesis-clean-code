...
class setup_class:
    def __init__(self, prob, use_CEM=False, delta_t=None, max_steps=None, stage_cost_weight=None, terminal_cost_weight=None):
        self.prob = prob
        ...
        if prob == "CartPole":
        ...
        elif self.prob == "Pendulum_TrueMPC":
        ...
        elif self.prob == "Cartpole_TrueMPC":
            self.discrete = False
            self.horizon = 20
            # self.max_episodes = 300
            # self.max_steps = 200
            ...
            self.stage_cost_weight    = torch.tensor([5.0, 10.0, 0.1, 0.1]) # weight for [x, theta, x_dot, theta_dot]
            self.terminal_cost_weight = torch.tensor([5.0, 10.0, 0.1, 0.1]) # weight for [x, theta, x_dot, theta_dot]
